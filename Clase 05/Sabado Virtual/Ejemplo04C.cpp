...
/*
NOTA: resolver el ejercicio con esta estructura planteada, es decir, el ingreso de la donación una vez afuera del while y una vez adentro del while (antes
